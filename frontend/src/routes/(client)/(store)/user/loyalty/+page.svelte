  ...
  <div class="space-y-10" in:fade>
        ...
        <div class="flex items-center gap-3">
          {#if loyaltyStore.data.pending_points > 0}
            <div class="flex items-center gap-2 px-4 py-2 bg-luxury-copper/10 border border-luxury-copper/20 rounded-full animate-pulse-slow">
              ...
              <span class="text-[10px] font-black text-luxury-copper tracking-tighter ">+{loyaltyStore.data.pending_points} CHỜ DUYỆT</span>
            </div>
          {/if}
          <div class="flex items-center gap-2 px-4 py-2 bg-stone-50 border border-stone-100 rounded-full">
              ...
              <span class="text-[11px] font-black text-stone-700 tracking-tighter ">{loyaltyStore.data.available_points} điểm SẴN CÓ</span>
          </div>
        </div>
      {/if}
    </div>
    ...
    {:else if loyaltyStore.data}
        ...
        <div class="lg:col-span-6">
           ...
           <div class="mt-4 flex items-center justify-center gap-6">
              <div class="text-center">
                 <span class="block text-[8px] tracking-widest text-stone-400 font-bold">LTV</span>
              ...
              <div class="text-center">
                <span class="block text-[8px] tracking-widest text-stone-400 font-bold">Status</span>
      ...
      <div class="space-y-6 pt-6">
          <div class="flex items-center gap-3 border-b border-stone-100 pb-2">
              ...
              <h2 class="text-[12px] tracking-[2px] font-bold text-stone-800">Lịch sử biến động</h2>
          </div>
                          ...
                          <div class="px-6 py-5 flex justify-between items-center hover:bg-stone-50/50 transition-all duration-300 group">
                              <div class="flex items-center gap-4">
                                  ...
                                  <div class="flex flex-col">
                                      <span class="text-[13px] font-bold text-stone-800 group-hover:text-stone-800 transition-colors tracking-tight">{tx.notes || 'Giao dịch điểm'}</span>
    ...
    {:else if loyaltyStore.error}
      <div class="p-20 text-center flex flex-col items-center space-y-4 bg-red-50/30 border border-red-50 rounded-3xl">
          ...
          <div>
            <p class="text-red-500 font-bold tracking-widest text-[11px] mb-1">Hệ thống đang bảo trì dữ liệu</p>
      ...
      {:else if loyaltyStore.data}
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="p-4 bg-stone-50 border border-stone-100 rounded-2xl flex flex-col gap-1">
             <span class="text-[8px] font-black text-stone-400 tracking-widest">Tổng chi tiêu</span>
          ...
          <div class="p-4 bg-stone-800 text-white rounded-2xl flex flex-col gap-1">
            <span class="text-[8px] font-black text-stone-500 tracking-widest">Hạng hiện tại</span>
            <span class="text-sm font-black text-luxury-copper italic">{loyaltyStore.tierName}</span>
         </div>
        </div>
        ...
        <div class="space-y-4 p-5 bg-white border border-stone-100 rounded-2xl">
            <div class="flex justify-between items-center">
                <span class="text-[10px] font-black text-stone-800 tracking-widest">Tiến trình hạng</span>
            ...
            <div class="flex justify-between text-[8px] tracking-widest font-black text-stone-300">
                <span>Standard</span>
                <span>Silver</span>
                <span>Gold</span>
                <span>Elite</span>
        ...
        <div class="p-6 bg-[#fcfbf9] border border-[#f5f1e8] rounded-2xl relative overflow-hidden group">
            ...
            <div class="relative z-10 space-y-1">
                <span class="text-[9px] tracking-[2px] font-black text-stone-800">Quy tắc đổi thưởng</span>
                <p class="text-sm text-stone-600 font-serif italic">1 điểm = 1.000 VNĐ</p>
        ...
        <div class="space-y-5">
            <div class="flex items-center gap-2 border-b border-stone-100 pb-2">
                ...
                <h2 class="text-[11px] tracking-[2px] font-black text-stone-800">Lịch sử giao dịch</h2>
            </div>
