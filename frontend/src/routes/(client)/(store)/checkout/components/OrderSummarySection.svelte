...
<div class="space-y-3 pt-5 border-t border-gray-100">
  <div class="flex justify-between items-center group">
    <div class="flex items-center gap-2 text-[10px] font-bold text-gray-400 tracking-widest italic group-hover:text-gray-900 transition-colors">
  ...
  <div class="flex justify-between items-center group">
    <div class="flex items-center gap-2 text-[10px] font-bold text-gray-400 tracking-widest italic group-hover:text-emerald-500 transition-colors">
    ...
    <span class="{shippingFee > 0 ? 'text-gray-900' : 'text-emerald-500'} font-black italic text-xs tracking-tighter">
  ...
  {#if cartStore.selectedVoucherIds.length > 0}
    <div class="flex justify-between items-center bg-[#ee4d2d]/5 p-3 border-l-4 border-[#ee4d2d] group overflow-hidden relative" in:slide>
      <div class="flex items-center gap-2 text-[10px] font-black text-[#ee4d2d] italic relative z-10">
      ...
      <div class="flex items-center gap-3 relative z-10">
        ...
        <div>
          <div class="flex items-center gap-2">
            <span class="text-[11px] font-black {form.usePoints ? 'text-luxury-copper' : 'text-stone-400'} italic tracking-widest leading-none">Dùng {availablePoints} điểm tích lũy</span>
          ...
          <div class="bg-stone-900/95 backdrop-blur-xl border border-luxury-copper/30 p-4 rounded-2xl shadow-2xl relative overflow-hidden">
            ...
            <div class="flex flex-col gap-2 relative z-10">
              <div class="flex items-center gap-2 border-b border-luxury-copper/10 pb-2 mb-1">
                ...
                <span class="text-[9px] font-black text-luxury-copper tracking-[0.2em] italic">Quy trình tích điểm Elite V2.2</span>
              </div>
  ...
  <div class="pt-6 mt-4 border-t-2 border-dashed border-gray-100 flex flex-col items-end gap-1">
    <div class="flex items-center gap-2 text-[9px] font-black tracking-[0.3em] text-gray-400 italic">
    ...
    <div class="flex flex-col items-end gap-0">
      ...
      <div class="mt-2 flex items-center gap-1.5 bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/20">
        ...
        <span class="text-[9px] font-black text-amber-700 tracking-widest leading-none">Dự kiến tích lũy: +{Math.floor(finalTotal / 100000)} Pts</span>
      </div>
    </div>
    ...
    {#if totalSavings > 0}
      <div class="mt-4 w-full bg-emerald-50 border border-emerald-100 p-3 flex items-center justify-between group overflow-hidden relative" in:slide>
        <div class="flex items-center gap-2 relative z-10">
          ...
          <span class="text-[10px] font-black text-emerald-600 tracking-widest italic">Chúc mừng! Bạn đã tiết kiệm được</span>
        </div>
    ...
    <div class="w-full mt-6 bg-[#fff4f1] border border-orange-100 p-4 transition-all duration-300">
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1 min-w-0">
          <h3 class="text-[10px] font-black text-gray-900 tracking-widest flex items-center gap-1.5 leading-none">
          ...
          <div class="mt-3 grid grid-cols-2 gap-x-2 gap-y-1">
            <div class="flex items-center gap-1.5 text-[8px] font-black text-[#ee4d2d]/80 italic">
            ...
            <a href="/chinh-sach-kiem-hang" target="_blank" rel="noopener noreferrer" class="flex items-center gap-1.5 text-[8px] font-black text-[#ee4d2d]/80 italic hover:underline">
              <svg class="w-2.5 h-2.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>
            ...
            <a href="/chinh-sach-doi-tra-hoan-tien" target="_blank" rel="noopener noreferrer" class="flex items-center gap-1.5 text-[8px] font-black text-[#ee4d2d]/80 italic hover:underline">
              <svg class="w-2.5 h-2.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>
              Đổi trả 7 ngày
            </a>
          </div>
    ...
    <div class="flex items-center gap-2 text-[8px] text-gray-400 font-bold mt-4 tracking-tighter italic">
      <span>An toàn</span>
