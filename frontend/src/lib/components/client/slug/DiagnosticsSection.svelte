...
<section id="diagnostics" class="diagnostics-container snap-session relative overflow-x-hidden bg-[#020617]">
  <div class="container mx-auto px-6 max-w-5xl text-center relative pt-[8vh] pb-20" style="z-index: var(--z-surface); padding-top: 8vh !important;">
    ...
    <p class="section-description text-white/40 text-base md:text-lg max-w-2xl mx-auto leading-relaxed mb-8">
      Để hệ thống chẩn đoán của <span class="text-white/60">Nhà thuốc Hồng Sơn</span> thiết lập phác đồ liều lượng chính xác nhất, vui lòng chọn mức độ biểu hiện hiện tại của bạn.
    </p>
    ...
    <div class="mt-16 flex items-center justify-center gap-3 text-[10px] font-black tracking-[0.2em] text-white/20 uppercase bg-white/5 py-4 px-8 rounded-full border border-white/5 w-fit mx-auto backdrop-blur-md">
      ...
      Mọi thông tin được bảo mật tuyệt đối bởi Nhà thuốc Hồng Sơn
    </div>
  </div>
