...
<div class="border border-yellow-500/20 bg-yellow-950/5 rounded-xl p-5 relative overflow-hidden group">
  ...
  <div class="space-y-4">
    <div class="bg-[#0b0c10]/40 border border-gray-900 p-4 rounded-lg">
      ...
      <p class="text-xs text-cyan-100 font-medium leading-relaxed font-sans">{activeScript.core_message || "(Chưa phân tích)"}</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="bg-red-950/10 border border-red-500/10 p-4 rounded-lg space-y-2">
        ...
        <p class="text-[11px] text-red-200/90 leading-relaxed font-sans">{activeScript.competitor_weaknesses || "(Không phát hiện)"}</p>
      </div>
      ...
      <div class="bg-emerald-950/10 border border-emerald-500/10 p-4 rounded-lg space-y-2">
        ...
        <p class="text-[11px] text-emerald-200/90 leading-relaxed font-sans">{activeScript.our_usp || "(Chưa có USP)"}</p>
      </div>
    </div>
  </div>
</div>
