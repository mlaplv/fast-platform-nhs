...
<section class="mt-auto">
  ...
  >
    <div class="flex items-center justify-between">
      <span class="text-xs font-mono font-bold uppercase tracking-widest {nanobot.isCampaignMode ? 'text-red-400' : 'text-zinc-500'}">
        Fortress Mode
      </span>
    ...
    <p class="text-[10px] font-mono text-zinc-600 uppercase leading-relaxed tracking-wider">
