...
<div class="w-full h-full flex flex-col md:flex-row gap-6 p-2 animate-in fade-in duration-700">
  ...
  <div class="flex-1 flex flex-col gap-6 overflow-y-auto custom-scrollbar pb-10">
    ...
    <!-- 1. TRUST BADGES -->
    <div class="bg-gradient-to-br from-indigo-900/40 to-purple-900/40 border border-purple-500/30 rounded-3xl p-6 relative overflow-hidden group">
    ...
    <div class="bg-white rounded-3xl p-6 shadow-xl border border-gray-100 flex flex-col gap-3">
    ...
    <div class="bg-gradient-to-b from-[#e8f0fe] to-white rounded-3xl p-6 shadow-xl border border-blue-100 flex flex-col gap-3 relative overflow-hidden">
    ...
    <div class="bg-white rounded-3xl outline outline-1 outline-gray-200 shadow-xl overflow-hidden flex flex-col font-sans">
