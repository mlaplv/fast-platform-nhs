<script lang="ts">
  ...
  import UserMenuMobile from '../user/UserMenuMobile.svelte';
...
<header class="tsh-header" style="z-index:{Z_INDEX_CLIENT.HEADER}">
  ...
  <div class="tsh-top-row">
    <!-- Menu Button -->
    <button class="tsh-menu" type="button" onclick={() => isMenuOpen = true} aria-label="Menu">
        <Menu class="w-6 h-6" />
    </button>
...
<style>
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .tsh-cart-icon { width: 32px; height: 32px; }
