...
<style>
  ...
  /* Elite V2.2: Multi-level Viral Bullets for Mobile */
  ...
  /* Ordered Lists */
  :global(.prose-osmo ol) {
    counter-reset: osmo-counter-mobile;
  }
  :global(.prose-osmo ol > li) {
    counter-increment: osmo-counter-mobile;
  }
  :global(.prose-osmo ol > li::before) {
    content: counter(osmo-counter-mobile) "." !important;
    position: absolute !important;
    left: 0 !important;
    top: 0 !important;
    color: #ee4d2d !important;
