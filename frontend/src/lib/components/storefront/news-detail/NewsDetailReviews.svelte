...
<div id="news-reviews" class="max-w-[1200px] mx-auto bg-white p-6 mt-10 rounded-none relative overflow-hidden mb-10 shadow-[0_2px_20px_-5px_rgba(0,0,0,0.05)] border border-gray-50">
  <div class="flex flex-col md:flex-row items-center justify-between gap-6 mb-3 pb-2 border-b border-gray-50">
    <div>
      <h2 class="text-[24px] font-black text-[#1a1a1a] tracking-tight leading-none mb-2">Phản hồi từ độc giả</h2>
      <p class="text-gray-400 text-xs font-medium tracking-[0.2em]">Xác thực trải nghiệm người dùng</p>
    </div>
    <button 
      onclick={handleWriteReview}
      class="px-10 py-5 bg-gradient-to-r from-[#C18F7E] to-[#E3B5A4] text-white font-black rounded-none text-[11px] tracking-[0.3em] hover:opacity-90 hover:shadow-lg hover:-translate-y-1 transition-all border border-white/20">
      Viết cảm nhận ngay
    </button>
  </div>
