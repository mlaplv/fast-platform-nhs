...
>
  ...
  <div class="flex items-start justify-between px-5 pt-6 pb-2 flex-shrink-0 text-white">
    <div class="flex flex-col gap-1.5">
      <div class="font-black text-[22px] tracking-tight leading-none text-white">Trung tâm thưởng</div>
            ...
            <div class="flex flex-col bg-[#F9F9FB] rounded-[16px] overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.02)] border border-gray-100/50">
              ...
              <div class="p-3 flex flex-col flex-1">
                ...
                <div class="flex flex-wrap gap-1 mb-3">
                  ...
                  <!-- Tag 3: Cashback -->
                  <span class="text-[9px] font-extrabold px-1.5 py-0.5 rounded-[4px] bg-[#fffde7] text-[#b48800]">
                    Bonus Hoàn tiền
                  </span>
                </div>
