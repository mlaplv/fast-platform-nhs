    ...
    >
      ...
      <div class="relative z-10 p-8">
        ...
        <div class="grid grid-cols-2 gap-4">
          <button 
            onclick={modal.onCancel}
            class="py-4 px-6 border border-white/10 text-white font-black text-[10px] tracking-widest hover:bg-white/5 transition-all text-center"
          >
            {modal.cancelLabel}
          </button>
          ...
          <button 
            ...
            class="py-4 px-6 bg-[#ee4d2d] text-white font-black text-[10px] tracking-widest hover:brightness-110 transition-all text-center relative group overflow-hidden"
          >
