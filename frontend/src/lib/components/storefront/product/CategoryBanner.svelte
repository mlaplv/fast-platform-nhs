    ...
    >
      ...
      <div class="relative z-10 flex flex-col gap-4 max-w-[55%] ml-[-20px]">
        <div in:fly={{y: 20, duration: 1000, delay: 200}} class="flex items-center gap-3">
            <div class="flex items-center gap-0.5 bg-gradient-to-r from-[#ee4d2d] to-[#ff6a00] text-white px-2 py-1 italic font-black text-[10px] tracking-tighter shadow-[0_4px_10px_rgba(238,77,45,0.2)]">
                <span>F</span>
            ...
            <span class="text-black/30 text-[7px] font-black tracking-[0.3em]">Hàng hiếm có sẵn</span>
        </div>
        ...
        <div in:fly={{y: 30, duration: 1000, delay: 500}} class="flex items-center gap-8">
            <div class="flex flex-col">
                <div class="flex items-center gap-3 mb-1">
                    ...
                    <span class="text-[9px] text-[#ee4d2d] font-black tracking-widest animate-pulse">−55%</span>
                </div>
            ...
            <div class="flex flex-col">
                <span class="text-[8px] font-black tracking-[0.2em] text-black/20 mb-1">Đã tin dùng</span>
        ...
        <div in:fly={{y: 40, duration: 1000, delay: 700}} class="flex flex-col gap-3">
            <button 
                ...
                class="group/btn relative w-fit px-12 py-4 bg-black text-white text-[10px] font-black tracking-[0.3em] overflow-hidden transition-all active:scale-95 shadow-xl"
            >
        ...
        >
            ...
            {#each specs() as spec, idx}
                <div in:fly={{x: 30, duration: 1000, delay: 800 + (idx * 200)}} 
                    ...
                    <span class="text-[7px] font-black tracking-[0.1em] text-black/30">{spec.label}</span>
            ...
            <div in:fly={{x: -30, duration: 1000, delay: 1200}} 
                ...
                <span class="text-[8px] font-black tracking-[0.2em]">
