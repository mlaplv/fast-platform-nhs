...
/** @deprecated V3.0: Product JSON-LD is now built exclusively by Backend SeoService. */
...
/** @deprecated V3.0: Article JSON-LD is now built exclusively by Backend SeoService. */
