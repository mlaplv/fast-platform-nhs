...
from src.database.repositories import ArticleRepository, provide_article_repo
from src.database.models import Article
from src.guards import PermissionGuard
from src.utils.sql import escape_like
from src.schemas.article import CreateArticleRequest, UpdateArticleRequest, BulkIdsRequest
...
class ArticleController(Controller):
    ...
    async def _upsert_embedding(self, art_repo: ArticleRepository, article_id: str, title: str, content: Optional[str]):
        ...
        try:
            ...
            embeddings = await loop.run_in_executor(None, lambda: list(encoder.embed([text_to_embed])))
            if not embeddings:
                return
