...
<div class="w-full h-full flex flex-col relative bg-black/40 backdrop-blur-xl">
  <div class="flex flex-col gap-6 p-6 border-b border-white/[0.05]">
    ...
    <div
      class="flex items-center gap-4 bg-white/[0.02] border border-white/10 p-2.5 rounded-2xl shadow-inner backdrop-blur-md overflow-x-auto custom-scrollbar"
    >
      ...
      <div class="flex-1 relative group min-w-[250px]">
        ...
        <input
          ...
          class="w-full bg-black/50 border border-white/5 rounded-xl py-3 pl-12 pr-4 text-[11px] font-mono text-gray-200 placeholder:text-gray-600 focus:outline-none focus:border-[#FFB800]/50 focus:ring-2 focus:ring-[#FFB800]/20 transition-all uppercase tracking-widest shadow-inner shadow-black/50"
        />
      </div>

      <!-- Filters -->
      <div class="flex items-center gap-1 px-2 border-l border-white/10 pl-4 flex-shrink-0">
      ...
      <!-- Actions -->
      <div class="flex items-center gap-3 border-l border-white/10 pl-4 pr-2 flex-shrink-0">
        {#if selectedIds.size > 0}
          <button onclick={() => bulk("act")}
            class="px-3 py-2 text-[10px] font-mono uppercase bg-[#39FF14]/10 border border-[#39FF14]/30 text-[#39FF14] rounded-xl hover:bg-[#39FF14]/20 transition-all"
            ><Eye size={12} class="inline mr-1" /> Kích hoạt ({selectedIds.size})</button>
          <button onclick={() => bulk("del")}
            class="px-3 py-2 text-[10px] font-mono uppercase bg-red-500/10 border border-red-500/30 text-red-400 rounded-xl hover:bg-red-500/20 transition-all"
        ...
        <div class="flex items-center gap-1.5 text-[9px] font-mono text-gray-500 uppercase tracking-widest">
          ...
          <select
            ...
            class="bg-black/60 border border-white/10 rounded-md px-1.5 py-1 text-[#FFB800] text-[9px] font-mono font-bold focus:outline-none focus:border-[#FFB800]/50 cursor-pointer appearance-none text-center w-12"
          >
        ...
        <button onclick={openCreate}
          class="flex items-center gap-2 px-4 py-2 text-[10px] font-bold tracking-widest font-mono uppercase bg-[#FFB800]/10 border border-[#FFB800]/30 text-[#FFB800] hover:bg-[#FFB800]/20 hover:text-white rounded-xl transition-all duration-300"
        >
          <Plus size={14} /> Add_Product
        </button>
        <button onclick={loadProducts} title="Force Resync"
          class="p-2.5 text-gray-500 hover:text-[#FFB800] border border-white/5 hover:border-[#FFB800]/30 rounded-xl bg-black/40 hover:bg-[#FFB800]/10 transition-all"
        >
