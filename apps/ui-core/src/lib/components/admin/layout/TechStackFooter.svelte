...
<div
  class="absolute z-40 pointer-events-none opacity-40 hover:opacity-100 transition-opacity mix-blend-screen text-right bottom-0.5 right-6 flex items-center gap-3"
