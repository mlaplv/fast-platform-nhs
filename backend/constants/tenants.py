...
APP_DOMAIN = os.getenv("APP_DOMAIN", "osmo.vn").lower().replace("https://", "").replace("http://", "").rstrip("/")
ADMIN_DOMAIN = os.getenv("ADMIN_DOMAIN", "admin.osmo.vn").lower().replace("https://", "").replace("http://", "").rstrip("/")
API_DOMAIN = os.getenv("API_DOMAIN", "api.osmo.vn").lower().replace("https://", "").replace("http://", "").rstrip("/")
...
DOMAIN_TENANT_MAP: dict[str, str] = {
    ...
    "osmo.vn": APP_DOMAIN,
    "admin.osmo.vn": APP_DOMAIN,
    "api.osmo.vn": APP_DOMAIN,
