...
APP_DOMAIN = os.getenv("APP_DOMAIN", "micsmo.com").lower().replace("https://", "").replace("http://", "").rstrip("/")
ADMIN_DOMAIN = os.getenv("ADMIN_DOMAIN", "admin.micsmo.com").lower().replace("https://", "").replace("http://", "").rstrip("/")
API_DOMAIN = os.getenv("API_DOMAIN", "api.micsmo.com").lower().replace("https://", "").replace("http://", "").rstrip("/")
...
DOMAIN_TENANT_MAP: dict[str, str] = {
    ...
    "micsmo.com": APP_DOMAIN,
    "admin.micsmo.com": APP_DOMAIN,
    "api.micsmo.com": APP_DOMAIN,
