...
POLICIES = [
    {
        ...
        "excerpt": "Cam kết bảo mật tuyệt đối thông tin cá nhân của khách hàng khi tham gia mua sắm tại osmo.",
        "content": """
            <h2>1. Mục đích thu thập thông tin cá nhân</h2>
            <p>Việc thu thập dữ liệu chủ yếu trên Website TMĐT osmo bao gồm: email, điện thoại, tên đăng nhập, mật khẩu đăng nhập, địa chỉ khách hàng (thành viên). Đây là các thông tin mà osmo cần thành viên cung cấp bắt buộc khi đăng ký sử dụng dịch vụ và để osmo liên hệ xác nhận khi khách hàng đăng ký sử dụng dịch vụ trên website nhằm đảm bảo quyền lợi cho cho người tiêu dùng.</p>
            
            <h2>2. Phạm vi sử dụng thông tin</h2>
            <p>Website TMĐT osmo sử dụng thông tin thành viên cung cấp để:</p>
            <ul>
                <li>Cung cấp các dịch vụ đến Thành viên.</li>
                <li>Gửi các thông báo về các hoạt động trao đổi thông tin giữa thành viên và Website TMĐT osmo.</li>
            ...
            <p>Dữ liệu cá nhân của Thành viên sẽ được lưu trữ cho đến khi có yêu cầu hủy bỏ hoặc tự thành viên đăng nhập và thực hiện hủy bỏ. Còn lại trong mọi trường hợp thông tin cá nhân thành viên sẽ được bảo mật trên máy chủ của osmo.</p>
            ...
            <p>Thông tin cá nhân của thành viên trên osmo được osmo cam kết bảo mật tuyệt đối theo chính sách bảo vệ thông tin cá nhân của osmo. Việc thu thập và sử dụng thông tin của mỗi thành viên chỉ được thực hiện khi có sự đồng ý của khách hàng đó trừ những trường hợp pháp luật có quy định khác.</p>
        """,
        "seo_title": "Chính sách Bảo mật Thông tin - osmo",
        "seo_description": "Xem quy định về bảo mật dữ liệu và quyền riêng tư của khách hàng tại osmo."
    },
    {
        "id": "policy_terms",
        "title": "Điều khoản Dịch vụ",
        "slug": "dieu-khoan-dich-vu",
        "excerpt": "Các quy định và thỏa thuận pháp lý khi khách hàng truy cập và mua sắm tại nền tảng osmo.",
        "content": """
        ...
        """,
        "seo_title": "Điều khoản Dịch vụ và Quy định Chung - osmo",
        "seo_description": "Tìm hiểu các quy định sử dụng dịch vụ, quyền và nghĩa vụ của người dùng tại osmo."
    },
    {
        "id": "policy_refund",
        ...
        """,
        "seo_title": "Chính sách Đổi trả & Hoàn tiền trong 7 ngày - osmo",
        "seo_description": "Hướng dẫn quy trình đổi trả hàng và hoàn tiền nhanh chóng tại osmo."
    },
    {
        "id": "policy_shipping",
        ...
        "content": """
            ...
            <p>Mã vận đơn sẽ được gửi qua SMS hoặc email sau khi đơn hàng được đóng gói. Khách hàng có thể kiểm tra hành trình đơn hàng trực tiếp trên website osmo.</p>
        """,
        "seo_title": "Chính sách Vận chuyển và Giao nhận Toàn quốc - osmo",
    ...
    },
    {
        ...
        "content": """
            ...
            <p>Nếu sản phẩm không đúng hoặc có dấu hiệu hư hại, khách hàng có quyền từ chối nhận hàng và không thanh toán. Vui lòng liên hệ lại osmo để chúng tôi xử lý gửi lại đơn hàng mới.</p>
        ...
        """,
        "seo_title": "Chính sách Kiểm hàng (Đồng kiểm) - osmo",
        "seo_description": "Khách hàng được quyền kiểm tra hàng trước khi thanh toán tại osmo."
    },
    {
        "id": "policy_warranty",
        ...
        "content": """
            ...
            <p>Sản phẩm mỹ phẩm, thiết bị làm đẹp do osmo phân phối.</p>
        ...
        """,
        "seo_title": "Chính sách Bảo hành Sản phẩm - osmo",
        "seo_description": "Xem cam kết bảo hành và chất lượng sản phẩm từ osmo."
    },
    {
        "id": "policy_payment",
        "title": "Phương thức Thanh toán",
        "slug": "phuong-thuc-thanh-toan",
        "excerpt": "Hướng dẫn các phương thức thanh toán linh hoạt và an toàn tại osmo.",
        "content": """
            ...
            <p>Khách hàng có thể thanh toán trước qua tài khoản ngân hàng của osmo. Nội dung chuyển khoản ghi rõ: [Mã đơn hàng] - [Số điện thoại].</p>
        ...
        """,
        "seo_title": "Hướng dẫn các Phương thức Thanh toán - osmo",
        "seo_description": "Chọn phương thức thanh toán phù hợp: COD hoặc Chuyển khoản tại osmo."
    },
    {
        "id": "policy_about",
        "title": "Giới thiệu",
        "slug": "gioi-thieu",
        "excerpt": "osmo Elite - Biểu tượng của sự kết hợp giữa tri thức làm đẹp Nhật Bản và công nghệ AI 2026.",
        "content": """
            <h2>1. Tầm nhìn 2026</h2>
            <p>osmo Elite ra đời với sứ mệnh mang lại vẻ đẹp bền vững cho phụ nữ Việt Nam thông qua các sản phẩm cao cấp từ Nhật Bản, kết hợp với trải nghiệm mua sắm thông minh cá nhân hóa bởi AI.</p>
        ...
        """,
        "seo_title": "Giới thiệu về osmo Elite 2026",
        "seo_description": "Tìm hiểu về hành trình và tầm nhìn của osmo Elite trong việc kiến tạo vẻ đẹp hiện đại."
    },
    {
        "id": "policy_careers",
        "title": "Tuyển dụng",
        "slug": "tuyen-dung",
        "excerpt": "Gia nhập đội ngũ osmo Elite - Nơi tài năng trẻ và công nghệ hội tụ để tạo nên tương lai.",
        "content": """
            <h2>1. Môi trường làm việc</h2>
            <p>Tại osmo Elite, chúng tôi xây dựng một môi trường làm việc Hybrid hiện đại, tập trung vào sự sáng tạo và làm chủ công nghệ AI.</p>
            ...
            <p>Gửi CV của bạn về email: admin@osmo với tiêu đề [HỌ TÊN] - [VỊ TRÍ ỨNG TUYỂN].</p>
        """,
        "seo_title": "Cơ hội nghề nghiệp tại osmo Elite",
