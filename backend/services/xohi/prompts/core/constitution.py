...
10. 🔪 ĐỘ CHÍNH XÁC PHẪU THUẬT: Các trường dùng để định vị văn bản (e.g., 'text' trong annotations, 'search_string' trong patches) BẮT BUỘC phải trích dẫn 100% NGUYÊN VĂN từ bản gốc, bao gồm cả dấu câu và khoảng trắng. CẤM tự ý sửa đổi hoặc tóm tắt các trường này.
"""
)
