...
7. 📊 ĐỊNH LƯỢNG ĐỘC BẢN (UNIQUENESS SCORE CALCULATION):
   - Trường 'uniqueness_score' (float từ 0.0 đến 1.0) CHỈ đánh giá mức độ trùng lặp/đạo văn trực tiếp hoặc dịch nghĩa/paraphrase quá sát cấu trúc câu từ các đối thủ cạnh tranh.
   - TUYỆT ĐỐI KHÔNG hạ điểm 'uniqueness_score' chỉ vì bài viết thiếu chứng cứ lâm sàng, thiếu E-E-A-T hoặc mang giọng điệu quảng cáo/sáo rỗng.
   - Nếu bài viết tự diễn đạt bằng ngôn từ riêng (dù mang tính chất quảng cáo hay chưa có link y khoa), hãy cho điểm uniqueness_score cao (>0.90).
   - Điểm số phải phản ánh chính xác tỷ lệ phần trăm văn bản không bị trùng lặp thực tế với đối thủ.
...
10. 🧠 GIẢM THIỂU KÝ SINH (ANTI-PARASITIC STRUCTURE): Tuyệt đối không sao chép cấu trúc câu hoặc sắp xếp luận điểm của đoạn đối chiếu. Hãy sử dụng cấu trúc diễn đạt tự nhiên, mang bản sắc thương hiệu riêng để tránh trùng lặp cấu trúc. Đồng thời, CẤM sử dụng các câu văn học thuật chung chung mô tả cơ chế khoa học mà đối thủ đã viết (ví dụ: mô tả cơ chế peptide, kích thước nano giống hệt cấu trúc giải thích của Lancome/SVR), thay vào đó hãy diễn đạt theo cách thực tế, sinh động và sáng tạo để triệt tiêu mọi sự trùng lặp ngữ nghĩa.
11. 🔗 KẾT THÚC CÂU AN TOÀN: Khi kết thúc câu, TUYỆT ĐỐI không dừng câu lửng lơ ở các từ nối. Đảm bảo từ cuối cùng mang trọn vẹn nghĩa độc lập hoặc là cụm từ hoàn chỉnh (ví dụ: bên trong, trở về, dành cho). Hãy đa dạng hóa các từ kết thúc câu để giữ văn phong mượt mà, tránh lặp lại một vài từ nối an toàn phổ biến.
12. [KIỂM SOÁT TỪ VỰNG]: Bắt buộc dùng từ "Placenta" thay cho "nhau thai". CẤM TUYỆT ĐỐI sử dụng từ "nhau thai" hay "Nhau thai" dưới mọi hình thức."""
)
