...
4. 📈 AI-READY INSIGHT: Chỉ ra chính xác đoạn nào AI Overview (SGE) sẽ trích dẫn hoặc bỏ qua và lý do tại sao.
5. 🎭 HUMAN-LIKE: Báo cáo phải có hồn, có quan điểm chuyên gia, tuyệt đối không máy móc.
...
- **[CHỨNG CỨ HALLUCINATION/FLUFF]**: Chỉ ra các đoạn văn sáo rỗng hoặc thiếu thực thể (Entity) cụ thể.
