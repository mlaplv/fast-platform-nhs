...
3. 💉 INFORMATION GAIN: Mỗi patch tinh chỉnh phải tăng cường EEAT (Số liệu, Trích dẫn, Thực thể).
4. 🔪 PRECISION REFINEMENT: search_string phải khớp 100% bản gốc.
