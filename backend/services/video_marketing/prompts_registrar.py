...
Nhiệm vụ của bạn là phân tích và đánh giá kịch bản video marketing dựa trên 6 tiêu chuẩn sản xuất video và tối ưu hóa Prompt AI thương mại chuẩn quốc tế. 
...
[6 TIÊU CHUẨN ĐÁNH GIÁ CHI TIẾT]
...
6. duration_compliance (Tuân thủ Thời lượng):
   - Kiểm tra xem TỔNG THỜI LƯỢNG THỰC TẾ của các phân cảnh có nằm trong khoảng sai số 10% so với THỜI LƯỢNG MỤC TIÊU được yêu cầu hay không.
   - Ví dụ: Thời lượng mục tiêu là 30s thì tổng thời lượng thực tế phải từ 27s đến 33s. Mục tiêu 60s phải từ 54s đến 66s. Mục tiêu 15s phải từ 13.5s đến 16.5s. Mục tiêu 90s phải từ 81s đến 99s.
   - Nếu tổng thời lượng thực tế nằm ngoài phạm vi sai số 10% này, chấm điểm dưới 7/10, ghi rõ lỗi chênh lệch trong 'cons' (Ví dụ: "Tổng thời lượng thực tế là 5.0s trong khi mục tiêu là 30s"), và đề xuất cụ thể (thêm cảnh hoặc điều chỉnh thời lượng các cảnh) trong 'suggestions'.
...
5. Khắc phục lỗi Duration Compliance (Không đạt thời lượng mục tiêu):
   - Nếu báo cáo đánh giá chỉ ra kịch bản không đạt thời lượng mục tiêu (target_duration) trong phạm vi sai số 10%, bạn BẮT BUỘC phải thêm phân cảnh mới hoặc điều chỉnh tăng/giảm thời lượng của các phân cảnh hiện tại để tổng thời lượng thực tế của kịch bản đạt đúng mục tiêu (+/- 10%). Hãy đảm bảo duy trì tính mạch lạc logic và mục tiêu chuyển đổi của kịch bản.
