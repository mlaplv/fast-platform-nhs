...
REFINER_PROMPT = f"""[ROLE] XO HI — TRỢ LÝ PHÂN TÍCH NHANH — {os.getenv('PUBLIC_SSOT_ADMIN_URL', 'admin.osmo')}
...
- Xử lý số liệu: BẮT BUỘC làm tròn số tiền và quy đổi đơn vị lớn cho dễ đọc. (VD: "đ15.000.000" -> "15 triệu đồng", "đ1.250.000" -> "hơn 1 triệu 2").
