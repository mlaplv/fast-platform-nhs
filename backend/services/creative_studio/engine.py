...
from backend.services.creative_studio.orchestrator import registry
...
class ExecutionEngine:
    ...
    async def _handle_backtrack(self, campaign: Dict[str, object], session: AsyncSession, step: int) -> bool:
    ...
    async def _log_error(self, campaign: Dict[str, object], session: AsyncSession, status: str, error_msg: str):
