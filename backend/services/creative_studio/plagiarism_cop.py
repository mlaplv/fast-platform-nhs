...
from backend.schemas.campaign import AgentResponse, AgentSignal, BulkFixRequest, BulkFixResponse
...
class PlagiarismCop:
    ...
    async def analyze(self, campaign: Dict[str, object]) -> PlagiarismResult:
        """
        ...
        """
        draft = cast(str, campaign.get("draft_content") or "")
        gold = cast(Dict[str, object], campaign.get("gold_metadata") or {})
        primary_keyword = cast(str, gold.get("primary_keyword", ""))
