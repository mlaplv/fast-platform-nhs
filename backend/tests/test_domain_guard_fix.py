...
SECRET_KEY = os.environ.get("ENCRYPTION_SALT", "Micsmo_Elite_Standard_Salt_2026")
ALGORITHM = "HS256"
...
async def test_super_admin_mutation_bypass():
    ...
    async with AsyncClient(transport=ASGITransport(app=app), base_url="https://micsmo.com") as client:
