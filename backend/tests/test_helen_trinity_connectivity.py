...
async def test_helen_connectivity() -> None:
    ...
    primary: str = trinity_bridge.default_model_name
    key_count: int = key_rotator.get_count()
    ...
    prompt: str = "Địa chỉ nhà thuốc của mình ở đâu vậy Helen?"
    context: str = "[CONTEXT KNOWLEDGE] Địa chỉ nhà thuốc Hồng Sơn: 33 Ngô Thị Nhậm, Trung Sơn, Tam Điệp, Ninh Bình."
    ...
    try:
        ...
        data: TestResponse = cast(TestResponse, res)
