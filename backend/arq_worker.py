...
from backend.infra.jobs import cleanup_old_tasks, helen_follow_up_job, helen_self_learning_job, generate_review_kg_job, cleanup_old_notifications, expire_loyalty_points_job, seo_nightly_reconciliation_job, seo_match_entity_job, seo_bulk_match_job, seo_unmatch_entity_job
...
class WorkerSettings:
    ...
    functions = [run_agent_task, helen_follow_up_job, send_otp_email, run_fraud_forensic, helen_self_learning_job, generate_review_kg_job, cleanup_old_notifications, seo_match_entity_job, seo_nightly_reconciliation_job, seo_bulk_match_job, seo_unmatch_entity_job]
...
class WorkerHighSettings(WorkerSettings):
    ...
    functions = [
        ...
        seo_match_entity_job, seo_nightly_reconciliation_job, seo_bulk_match_job, seo_unmatch_entity_job
    ]
