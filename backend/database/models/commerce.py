...
class Order(Base, AuditMixin, SoftDeleteMixin, TenantMixin):
    ...
    order_metadata: Mapped[dict] = mapped_column(JSONB, default=dict)
...
class ProductVariant(Base, AuditMixin, SoftDeleteMixin):
    ...
    tier_index: Mapped[Optional[list]] = mapped_column(JSONB, default=list) # R102 Matrix Index: e.g [0, 1] means Đỏ, Size M
